...
import RMSModule from './components/RMSModule';
...
const App: React.FC = () => {
  ...
  const addCompetitor = (name: string) => {
      ...
      const updatedData = data.map(day => {
          const variance = (Math.random() * 0.3) - 0.15;
          const rate = Math.round(day.adr * (1 + variance));
          return {
              ...day,
              competitorRates: { ...day.competitorRates, [newId]: rate }
          };
      });
      setData(updatedData);
  };
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            {sidebarOpen ? (
                <>
                    ...
                    <NavItem viewState={ViewState.RMS} icon={TrendingUp} label="RMS" />
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 border-l border-slate-200 pl-6">
              ...
              <div className="group relative">
                ...
                {/* Dropdown for logout */}
                <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-slate-100 hidden group-hover:block p-1">
